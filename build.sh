...
export IMG_FILENAME="${IMG_FILENAME:-"${IMG_NAME}-v${IMG_VERSION}"}"
export ZIP_FILENAME="${ZIP_FILENAME:-"image_${IMG_NAME}-v${IMG_VERSION}"}"

export SCRIPT_DIR="${BASE_DIR}/scripts"
export WORK_DIR="${WORK_DIR:-"${BASE_DIR}/work/${IMG_NAME}-v${IMG_VERSION}"}"
